...
export type NativeAndroidPairingAttestation = {
	...
	/**
	 * Optional extension for captures/builds that explicitly emit it. The
	 * controlled WABA QR capture emits key_attestation + gpia only.
	 */
...
export type NativeAndroidAttestationProvider = (context: {
	stanza: BinaryNode
	profileId: string
}) => Promise<NativeAndroidPairingAttestation | null>
...
export type NativeAndroidTransportConfig = {
	...
	/**
	 * Returns genuine artifacts for the active device/challenge. Returning null
	 * explicitly requests an attestation-free protocol probe; no synthetic
	 * artifacts are ever generated by the library.
	 */
